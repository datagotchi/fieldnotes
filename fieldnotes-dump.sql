...
17	1	15	11/19
18	3	15	kent city hs & ms
19	1	16	11/20
20	3	16	kent city hs
21	1	18	11/24
...
35	1	23	12/5
36	3	23	Sparta MS
37	2	23	autism spectrum disorder (ASD) classroom
38	1	24	12/8
...
44	6	19	To create a calm, productive learning environment (1st hour). To ensure all student needs were met and to check-in/be available (Focus/Office).
...
2	bob@datagotchi.net	$2b$10$grxJXu0y.zepdSntX1uB1.CRmX9d/qLFC8riii3gveeUwMP6rRoYm	$2b$10$nimPEMbQLXrhP3MwVu00jetJXMVZ80.bulCOkV66u0qQ/ub.cXjOC
\.
...
SELECT pg_catalog.setval('public.field_values_id_seq', 45, true);
...
SELECT pg_catalog.setval('public.notes_id_seq', 27, true);
